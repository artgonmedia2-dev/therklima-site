...
const TARIFS_DATA = [
  {
    metier: "electricite",
    prestations: [
      { label: "Diagnostic électrique complet", price: "À partir de 122 €" },
      { label: "Remplacement tableau électrique", price: "810 € — 2 025 €" },
      { label: "Mise en conformité NF C 15-100", price: "2 025 € — 6 750 €" },
      { label: "Installation prise / interrupteur", price: "108 € — 203 €" },
      { label: "Borne recharge véhicule électrique", price: "1 080 € — 2 430 €" },
    ],
  },
  {
    metier: "plomberie",
    prestations: [
      { label: "Dépannage fuite urgence", price: "À partir de 135 €" },
      { label: "Débouchage canalisation", price: "162 € — 405 €" },
      { label: "Remplacement chauffe-eau électrique", price: "540 € — 1 215 €" },
      { label: "Chauffe-eau thermodynamique", price: "1 620 € — 3 375 €" },
      { label: "Rénovation salle de bain", price: "4 050 € — 16 200 €" },
    ],
  },
  {
    metier: "chauffage",
    prestations: [
      { label: "Entretien annuel chaudière gaz", price: "162 € — 270 €" },
      { label: "Installation chaudière à condensation", price: "3 375 € — 6 750 €" },
      { label: "Dépannage panne chauffage", price: "À partir de 135 €" },
      { label: "Remplacement radiateur", price: "270 € — 675 €" },
      { label: "Plancher chauffant (par m²)", price: "68 € — 162 €/m²" },
    ],
  },
  {
    metier: "climatisation",
    prestations: [
      { label: "Installation split mural mono", price: "1 620 € — 3 375 €" },
      { label: "Système bi-split (2 unités)", price: "3 375 € — 6 075 €" },
      { label: "Multi-split (3 à 5 unités)", price: "5 400 € — 10 800 €" },
      { label: "Entretien annuel climatisation", price: "135 € — 270 €" },
      { label: "Dépannage panne clim", price: "À partir de 162 €" },
    ],
  },
  {
    metier: "pac",
    prestations: [
      { label: "PAC air-air 3,5 kW", price: "2 430 € — 4 725 €" },
      { label: "PAC air-eau 8 kW (100m²)", price: "10 800 € — 18 900 €" },
      { label: "PAC air-eau 12 kW (150m²)", price: "13 500 € — 24 300 €" },
      { label: "Entretien annuel PAC", price: "162 € — 338 €" },
  ...
  },
  {
    metier: "ventilation",
    prestations: [
      { label: "VMC simple flux (appartement)", price: "1 080 € — 2 430 €" },
      { label: "VMC hygroréglable", price: "1 620 € — 3 375 €" },
      { label: "VMC double flux (maison)", price: "4 725 € — 9 450 €" },
      { label: "Entretien annuel VMC", price: "108 € — 203 €" },
      { label: "Nettoyage réseau de conduits", price: "270 € — 675 €" },
    ],
  },
];
